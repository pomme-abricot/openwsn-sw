...
_ghmmwrapper.SMO_FILE_SUPPORT_swigconstant(_ghmmwrapper)
SMO_FILE_SUPPORT = _ghmmwrapper.SMO_FILE_SUPPORT

_ghmmwrapper.ASCI_SEQ_FILE_swigconstant(_ghmmwrapper)
ASCI_SEQ_FILE = _ghmmwrapper.ASCI_SEQ_FILE

_ghmmwrapper.SEQ_LABEL_FIELD_swigconstant(_ghmmwrapper)
SEQ_LABEL_FIELD = _ghmmwrapper.SEQ_LABEL_FIELD

_ghmmwrapper.kNotSpecified_swigconstant(_ghmmwrapper)
kNotSpecified = _ghmmwrapper.kNotSpecified

_ghmmwrapper.kLeftRight_swigconstant(_ghmmwrapper)
kLeftRight = _ghmmwrapper.kLeftRight

_ghmmwrapper.kSilentStates_swigconstant(_ghmmwrapper)
kSilentStates = _ghmmwrapper.kSilentStates

_ghmmwrapper.kTiedEmissions_swigconstant(_ghmmwrapper)
kTiedEmissions = _ghmmwrapper.kTiedEmissions

_ghmmwrapper.kUntied_swigconstant(_ghmmwrapper)
kUntied = _ghmmwrapper.kUntied

_ghmmwrapper.kHigherOrderEmissions_swigconstant(_ghmmwrapper)
kHigherOrderEmissions = _ghmmwrapper.kHigherOrderEmissions

_ghmmwrapper.kBackgroundDistributions_swigconstant(_ghmmwrapper)
kBackgroundDistributions = _ghmmwrapper.kBackgroundDistributions

_ghmmwrapper.kNoBackgroundDistribution_swigconstant(_ghmmwrapper)
kNoBackgroundDistribution = _ghmmwrapper.kNoBackgroundDistribution

_ghmmwrapper.kLabeledStates_swigconstant(_ghmmwrapper)
kLabeledStates = _ghmmwrapper.kLabeledStates

_ghmmwrapper.kTransitionClasses_swigconstant(_ghmmwrapper)
kTransitionClasses = _ghmmwrapper.kTransitionClasses

_ghmmwrapper.kDiscreteHMM_swigconstant(_ghmmwrapper)
kDiscreteHMM = _ghmmwrapper.kDiscreteHMM

_ghmmwrapper.kContinuousHMM_swigconstant(_ghmmwrapper)
kContinuousHMM = _ghmmwrapper.kContinuousHMM

_ghmmwrapper.kPairHMM_swigconstant(_ghmmwrapper)
kPairHMM = _ghmmwrapper.kPairHMM

_ghmmwrapper.kMultivariate_swigconstant(_ghmmwrapper)
kMultivariate = _ghmmwrapper.kMultivariate

_ghmmwrapper.EPS_ITER_BW_swigconstant(_ghmmwrapper)
EPS_ITER_BW = _ghmmwrapper.EPS_ITER_BW

_ghmmwrapper.MAX_ITER_BW_swigconstant(_ghmmwrapper)
...
_ghmmwrapper.normal_swigconstant(_ghmmwrapper)
normal = _ghmmwrapper.normal

_ghmmwrapper.normal_right_swigconstant(_ghmmwrapper)
normal_right = _ghmmwrapper.normal_right

_ghmmwrapper.normal_approx_swigconstant(_ghmmwrapper)
normal_approx = _ghmmwrapper.normal_approx

_ghmmwrapper.normal_left_swigconstant(_ghmmwrapper)
normal_left = _ghmmwrapper.normal_left

_ghmmwrapper.uniform_swigconstant(_ghmmwrapper)
uniform = _ghmmwrapper.uniform

_ghmmwrapper.binormal_swigconstant(_ghmmwrapper)
binormal = _ghmmwrapper.binormal

_ghmmwrapper.multinormal_swigconstant(_ghmmwrapper)
multinormal = _ghmmwrapper.multinormal

_ghmmwrapper.density_number_swigconstant(_ghmmwrapper)
