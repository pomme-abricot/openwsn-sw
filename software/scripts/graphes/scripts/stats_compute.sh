...
do
	...
	DIR="$CUR_DIR/../$BASENAME/data/$SUBDIR"
        ...
        do
        	...
        	do
	        	...
	        	do    
					...
					do
						echo $SUBDIR
						DIREXP="$DIR/$SUBDIR/distribshared=$DISTRCELLS,tracks=$TRACKS,rplmetric=$RPLMETRIC,schedalgo=$SCHEDALGO*/*"
						echo "Handling directory $DIREXP"
