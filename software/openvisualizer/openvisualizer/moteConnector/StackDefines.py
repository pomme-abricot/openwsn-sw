...
errorDescriptions = {
  ...
  45: "freeing unused memory  (code location  {0})",
  46: "freeing memory unsupported memory (code location  {0})",
  ...
  58: "not enough bandwidth in OTF (trackInstance {0}, nbCells to add {1})",
